...
from Tools_Face_Detection_System.Face_Detection_MobileNets import SSDFaceDetector, LandmarkDetector
...
def face_detection_with_Haarcacade(image, 
                                   CasscadeModel = './Tools_Face_Detection_System/CasscadeModel/lbpcascade_frontalface_improved.xml'):
...
class Mobilenetboxes():
    def __init__(self, model_direction:str = "./Tools_Face_Detection_System/MobilenetModels/ssd_int8_cpu.tflite"):
    ...
    def call(self, image):
      ...
      print(tcolors.RED, "5 ", image.dtype, tcolors.ENDC)

      bboxes = self.face_detect_router.predict(image)
      print(tcolors.RED, "bboxes ", bboxes, tcolors.ENDC)
...
def MobilenetboxesHalf(image, model_direction = "./Tools_Face_Detection_System/MobilenetModels/ssd_int8_cpu.tflite"):
...
def MobilenetMix(image, model_direction = ""):
    ...
    model_direction_1 = "./Tools_Face_Detection_System/MobilenetModels/ssd_int8_cpu.tflite"
    model_direction_2 = "./Tools_Face_Detection_System/MobilenetModels/mobilenet_fp32_cpu.tflite"
...
def LpbcacadeMix(image, model_direction = ""):
    ...
    model_direction_1 = "./Tools_Face_Detection_System/MobilenetModels/ssd_int8_cpu.tflite"
    model_direction_2 = "./Tools_Face_Detection_System/CasscadeModel/lbpcascade_frontalface_improved.xml"
